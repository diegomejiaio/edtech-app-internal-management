...
import { Ban, Banknote, Pencil, Plus, RotateCcw } from 'lucide-react';
...
export default function PaymentMethodsPage() {
  ...
  function handleSubmit(ev: FormEvent<HTMLFormElement>) {
    ...
    if (!value) {
      toast.error('Ingresa el nombre del medio');
      return;
    }
    ...
    mutation
      .then(() => {
        setOpen(false);
        setEditing(null);
        toast.success(editing ? 'Medio actualizado' : `"${value}" agregado`);
      })
      .catch((err) => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Medios de pago" subtitle="Catálogo de medios de pago disponibles" backHref="/catalogs">
