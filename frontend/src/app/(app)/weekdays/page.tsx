...
import { Ban, CalendarDays, Pencil, Plus, RotateCcw } from 'lucide-react';
...
export default function WeekdaysPage() {
  ...
  function handleSubmit(ev: FormEvent<HTMLFormElement>) {
    ...
    mutation
      .then(() => {
        setOpen(false);
        setEditing(null);
        toast.success(editing ? 'Día actualizado' : `"${value}" agregado`);
      })
      .catch((err) => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Días" subtitle="Catálogo de días para horarios" backHref="/catalogs">
      ...
      <FormSheetDialog
        ...
        title={editing ? 'Editar día' : 'Nuevo día'}
