...
import { Ban, Megaphone, Pencil, Plus, RotateCcw } from 'lucide-react';
...
export default function StudentSourcesPage() {
  ...
  function handleSubmit(ev: FormEvent<HTMLFormElement>) {
    ...
    mutation
      .then(() => {
        setOpen(false);
        setEditing(null);
        toast.success(editing ? 'Fuente actualizada' : `"${value}" agregada`);
      })
      .catch((err) => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Fuentes de alumnos" subtitle="Cómo nos conocieron los alumnos" backHref="/catalogs">
