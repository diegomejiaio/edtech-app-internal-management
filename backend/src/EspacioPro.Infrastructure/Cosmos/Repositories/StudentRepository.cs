...
public sealed class StudentRepository : CosmosRepository<Student>
{
    ...
    /// <summary>Finds a <see cref="Student"/> by its short business <c>code</c>.</summary>
    public async Task<Student?> GetByCodeAsync(string code, bool includeInactive = false, CancellationToken ct = default)
    {
